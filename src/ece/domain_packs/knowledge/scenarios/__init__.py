# cut-043 — Knowledge Management pack scenarios.
#
...
#
# Mirrors `procurement/scenarios/__init__.py` to keep the two packs
# structurally identical (PRD §5 底座泛化: "换域不换底座").

from ece.domain_packs.knowledge.agent import v0_rules  # noqa: F401 (side-effect import)
