"""S1.2 ontology loader for Compliance pack.
...
cut-044 — INVERTED registration. Pack side imports the resolver and registers
itself for the `comp` source-system prefix. The resolver does NOT import this
module (that would re-introduce the isolation violation). Mirrors the cut-043
KM pack inversion (R5-B3 lesson).
"""
...
register_ontology_for_system(
    "comp",  # covers source_system="comp:v0-compliance-fixture"
