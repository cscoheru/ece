...
[1m[31mE   AssertionError: policy_id=KM-POL-001 employee_id=km-alice: decision_value='needs_valid_policy' != expected='answerable'[0m
...
[31mFAILED[0m tests/integration/test_knowledge_boundary.py::[1mtest_knowledge_boundary_truth_table[validity_pass_perm_pass_answerable][0m - AssertionError: policy_id=KM-POL-001 employee_id=km-alice: decision_value='...
