# cut-044 Mutation Anchor M3 — comp_decision_force_gap_list
...
Forcing decision_value="gap_list" always means even the sufficient case (CTL-001 with both conditions passing) returns gap_list. This breaks the decision_value binding invariant the truth-table test asserts.
